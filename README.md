...
Բովանդակությունը խմբագրվում է առանձին վահանակից՝
[SamGrig96/arkomp-admin](https://github.com/SamGrig96/arkomp-admin) — մուտք
օգտանունով, ապրանքների ցանկ, նկարների վերբեռնում drag&drop-ով, տեքստերը երկու
լեզվով, հերթականություն։ Այն գրում է նույն `arkomp-api`-ի բազայի մեջ, ուստի
փոփոխությունը երևում է կայքում։

## Ինչ է դեռ բաց

- **Լուսանկարներ** — ապրանքների նկարներն արդեն վերցվում են API-ից. վերբեռնիր
  admin վահանակից, և քարտերն ու ապրանքի էջը ցույց կտան դրանք (`ImageSlot`-ը
